...
def test_on_folder(folder_path, output_csv='test_results.csv', output_folder= 'new_data' , max_images=None, verbose=True):
    """
    Pipeline on several images in a folder.
    Args:
        folder_path, outpuu_csv, output_folder, max_images, verbose
    Returns:
        dataframe csv for submission
    """
    ...
    for img_path in tqdm(test_images, desc="Traitement des images"):
        ...
        # create subfolder per image if verbose 
